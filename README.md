...
**Прибрати вручну в Google Cloud Console:** `drive.readonly` зі списку scope на OAuth
consent screen. Застосунок його вже не просить, але поки він у списку — тягне за собою
вимогу верифікації й щорічного аудиту CASA.
